...
<header>
    ...
    <h1>Tambah Jadwal Sidang MKS</h1>
		...
		<form method="post" id="form-jadwalSidang">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="form-group">
                       ...
                       <input type="text" class="form-control" id="tanggal" placeholder="19-11-2016" required /> </select>
                    </div>
                    <div class="form-group">
                       <label for="jamMulai"> Jam Mulai </label>
                       <input type="text" class="form-control" id="jamMulai" required="" placeholder="12:30"/>
                       <label for="jamSelesai"> Jam Selesai </label>
                        <input type="text" class="form-control" id="jamSelesai" required="" placeholder="12:00"/>
                       </select>
           ...
           <a href="../LihatJadwalSidang/jadwalAdmin.php" type="button" class="btn btn-primary"> Cancel </a>
        </form>
	</div>
</body>
